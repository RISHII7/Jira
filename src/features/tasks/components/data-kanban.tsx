...
export const DataKanban = ({ data, onChange }: DataKanbanProps) => {
    ...
    const onDragEnd = useCallback((result: DropResult) => {
        ...
        setTasks((prevTasks) => {
            ...
            const destinationColum = [...newTasks[destinationStatus]];
            destinationColum.splice(destination.index, 0, updatedMovedTask);
            newTasks[destinationStatus] = destinationColum;
            ...
            // if the task moved between columns, updates positions in the source column
